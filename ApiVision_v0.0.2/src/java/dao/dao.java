...
public class dao {
    public model consultarapiVision(model dl) throws JSONException, IOException {
        ...
        try {
            HttpPost request = new HttpPost("https://vision.googleapis.com/v1/images:annotate?key=AIzaSyBOd2BpX9qpj0O0C9t9yy6SVOY8f3W04Dg");// creamos la conexion con el API
